            ...
            <ScrollView style={{ marginBottom: 50 }}>
              <View style={{ backgroundColor: "#47B7BA", overflow: "hidden" }}>
                ...
                >
                  ...
                  >
                    <TouchableWithoutFeedback onPress={() => props.navigation.navigate({ routeName: "BookSchedule" })}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <View>
                  ...
                  >
                    <TouchableWithoutFeedback onPress={() => props.navigation.navigate({ routeName: "Profile" })}>
                      <View
                        style={{
                          justifyContent: "flex-start",
                          alignItems: "center",
            ...
            >
              ...
              <TouchableWithoutFeedback onPress={() => props.navigation.navigate({ routeName: "PushNotification" })}>
                ...
                >
                  ...
                  <Text style={{ color: "gray", fontSize: 10 }}> Push Notification</Text>
                </View>
              </TouchableWithoutFeedback>
              <View
                style={{
