...
export default class ModalHealthyBook extends Component {
  ...
  async componentDidMount() {
    let { allHtml, allCLS, profile } = await this.getWebView();

    this.setState({ html: allHtml.map(item => cutScript(item)), cls: allCLS, profile: profile });
